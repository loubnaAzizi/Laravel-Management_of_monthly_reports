...
<div class="wrapper d-flex align-items-stretch bg-light">
    ...
    <div class="container m-3 ">
        <div class="card">
            <div class="card-body">
                        <form method="POST" action="{{route('update.chef.profile')}}">
                            @csrf        
                                    ...
                                    <div class="row register-form ">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Email</label>
                                                <input type="text" name="email" id="SujetC"  class="form-control @error('email') is-invalid @enderror"   value="{{$user->email}}"/>
                                            </div>
                                            @error('email')
                        ...
                        <div class="card">
                            <div class="card-body">
                        <form method="POST" action="{{route('update.chef.password')}}">
                            @csrf        
                                <div class="form-section "  id="contraints_div">
                                    <div class="row">
